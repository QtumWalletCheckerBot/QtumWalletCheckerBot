...
namespace wallet_checker.Command
{
    class RestartMachine : ICommand
    {
        ...
        {
            return eCommand.RestartMachine;
        }
        ...
        {
            return strings.GetString("머신 재시작");
        }
        ...
        {
            return strings.GetString("지갑을 실행되고 있는 컴퓨터를 재시작 합니다.");
        }
